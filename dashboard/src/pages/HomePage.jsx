...
import { clearAllUserErrors, logout } from "@/store/slices/usersSlice";
...
import Dashboard from "./sub-componenets/Dashboard";
import AddProject from "./sub-componenets/AddProject";
import AddSkill from "./sub-componenets/AddSkill";
import AddApplication from "./sub-componenets/AddApplication";
import AddTimeline from "./sub-componenets/AddTimeline";
import Messages from "./sub-componenets/Messages";
import Account from "./sub-componenets/Account";
      ...
      <div className="flex min-h-screen w-full flex-col bg-muted/40">
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]">
          <Sheet>
            ...
            <SheetContent side="left" className="sm:max-w-x5">
          ...
          <div className="flex items-center gap-4 md:grow-0 sm:ml-16 sm:mt-5">
            ...
            <h1 className="text-4xl max-[900px]:text-2xl">
              Welcom back, {user && user.fullName && user.fullName}
            </h1>
          </div>
        </header>
        {(() => {
